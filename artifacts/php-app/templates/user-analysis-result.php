...
<div class="flex items-center justify-between mb-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <a href="https://x.com/<?= htmlspecialchars($pd['username']) ?>" target="_blank" rel="noopener noreferrer" class="text-blue-400 hover:text-blue-300 text-sm">@<?= htmlspecialchars($pd['username']) ?></a>
